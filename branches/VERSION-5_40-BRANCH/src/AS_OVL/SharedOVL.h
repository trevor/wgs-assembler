...
/* RCS info
 * $Id: SharedOVL.h,v 1.13.4.1 2009-07-07 23:54:31 adelcher Exp $
 * $Revision: 1.13.4.1 $
*/
...
static const char *rcsid_SHAREDOVL_H_INCLUDED = "$Id: SharedOVL.h,v 1.13.4.1 2009-07-07 23:54:31 adelcher Exp $";
